...
public class Operator {
    public static void main(String[] args) {
        ...
        System.out.printf("5만원 %d 장, 1만원 %d 장, 5천원 %d 장, 천원 %d장, 500원 %d개, 100원 %d개, 50원 %d개, 10원 %d개, 1원 %d개 입니다.",
                Share_fiftyThousand, Share_tenThousand, Share_fiveThousand, Share_Thousand, Share_fiveHundred, Share_Hundred, Share_Fifty, Share_Ten, theRest_Ten);
    }
